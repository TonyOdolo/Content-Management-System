...
?>
   ...
   <?php
        if(isLoggedIn()): ?>
            <div class="row">
                <p class="pull-right"><a
                        ...
                        data-toggle="tooltip"
                        data-placement="top"
                        title="<?php echo userLikedThisPost($the_post_id) ? ' You liked this before' : 'Want to like it?'; ?>">
                        </span>
      ...
      <?php else: ?>
            ...
            <div class="row">
                <p class="pull-right login-to-post">You need to <a href="/blogsystem/login.php">Login</a> to like </p>
            </div>
